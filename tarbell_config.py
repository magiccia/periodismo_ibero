...
SPREADSHEET_KEY = "1b-v-WemxEC8Ee5SVyx7v4EHF-04Ywfrw-7WMaMfK4Ms"
...
S3_BUCKETS = {
    ...
    "production": "recoveredfactory.net/periodismo_ibero",
    "staging": "recoveredfactory.net/periodismo_ibero",
}
...
DEFAULT_CONTEXT = {
    ...
    'keyed_data': {   'key1': {   'column1': u'key1, column1',
                      ...
                      'key2': {   'column1': u'key2, column1',
                                  ...
                                  'key': u'key2'}},
    'name': 'periodismo_ibero',
    'title': 'Periodismo Ibero'
}